...
Uses GNews API (100 requests/day free tier).
"""
...
class HistoricalSentimentTracker:
    ...
    def __init__(self, api_key=None):
        ...
        self.api_key = api_key or os.getenv('GNEWS_API_KEY', 'c9e8d95f5a05671f0a3e76caac6e4cc5')
        self.base_url = "https://gnews.io/api/v4/search"
        self.analyzer = SentimentIntensityAnalyzer()
        self.history_file = 'data/sentiment_history.csv'
        
    def fetch_news(self, query, days_back=7, max_articles=10):
        """Fetch recent news articles using GNews API"""
        params = {
            'q': query,
            'lang': 'en',
            'country': 'us',
            'max': min(max_articles, 10),  # Free tier max is 10
            'apikey': self.api_key
        }
        ...
        try:
            ...
            if 'articles' in data:
                ...
                print(f"⚠️  API error for {query}: {data.get('message', 'Unknown error')}")
                return []
